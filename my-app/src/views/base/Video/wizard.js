...
export default function Wizard() {
  ...
  return (
  <form id="regForm" action="/base/Contract">
  <h1>Add Video </h1>
  <div className="tab">
          ...
          <Form>
            ...
            <Col>
                  ...
                  <Row  style={{paddingTop:"5px"}}>
                    ...
                    <CFormSelect  value={Country} onChange={(e) => {setCountry(e.target.value)}}  isMulti={true} > 
                      <option align="center" >
                        Select Country
                      </option>
                      {
  ...
  <div style={{"overflow":"auto"}}>
    <div style={{"float":"right"}}>
      <button type="button" className='button1' id="prevBtn" onClick={() => nextPrev(-1)}>Previous</button> &nbsp;&nbsp;
      <button type="button" className='button1' id="nextBtn" onClick={() => nextPrev(1)}>Next</button>
    </div>
  </div>
